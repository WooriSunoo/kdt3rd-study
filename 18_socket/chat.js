...
io.on("connection", (socket) => {
  ...
  socket.on("disconnect", () => {
    ...
    // ex. aa님이 퇴장하셨습니다.
    // 3. nickArray에서 해당 유저 삭제(객체에서 key-value쌍 삭제)
    // delete연산자활용
  });
